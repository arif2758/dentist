...
const DoctorSchema = new Schema<IDoctorDoc>(
  {
    doctorId: { type: String, required: true, unique: true, default: "primary_doctor" },
    name: { type: String, required: true, default: "ডা. আরিফ চৌধুরী" },
    title: { type: String, default: "চিফ ডেন্টাল সার্জন ও এন্ডোডন্টিক বিশেষজ্ঞ" },
    degrees: [{ type: String }],
    ...
    chamberAddress: { type: String, default: "রুম #৪০২ (৪র্থ তলা), সিটি সেন্টার প্লাজা, ধানমন্ডি, ঢাকা" },
    schedule: [
      {
        day: { type: String },
        time: { type: String },
