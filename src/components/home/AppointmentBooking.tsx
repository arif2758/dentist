    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pt-4 sm:pt-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex sm:hidden items-center justify-between py-0.5 pb-2 border-b border-[var(--antd-border-split)]">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Link
            href="/live-queue"
            className="antd-btn antd-btn-default h-7 px-2 text-[11px] font-semibold flex items-center gap-1 shadow-xs"
          >
        ...
        <div>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="inline-flex items-center gap-1.5 antd-tag antd-tag-blue py-0.5 px-2 text-[11px] font-semibold">
              ...
              <span>ইনস্ট্যান্ট কনফার্মেশন</span>
            </div>
          </div>
        </div>
      ...
      {confirmedAppointment ? (
        ...
        /* 3. Main 2-Column Booking Interface */
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 items-start">
          {/* Left Column: Interactive Booking Form (8 Cols) */}
          <div className="lg:col-span-8 bg-[var(--antd-bg-container)] border border-[var(--antd-border-split)] rounded-2xl p-4 sm:p-7 shadow-xs">
            {/* Step Banner */}
            <div className="flex items-center justify-between pb-3.5 mb-5 border-b border-[var(--antd-border-split)]">
              <div>
                <h2 className="text-base sm:text-lg font-bold text-[var(--antd-text)]">
                  রোগীর তথ্য ও বুকিং ফরম
                </h2>
                <p className="text-[11px] text-[var(--antd-text-secondary)]">
                  সঠিক তথ্য প্রদান করে ইনস্ট্যান্ট ডিজিটাল টোকেন সংগ্রহ করুন
                </p>
              </div>
              <span className="antd-tag antd-tag-blue text-[11px] font-bold py-0.5 px-2">
                ১০০% ফ্রি অনলাইন সিরিয়াল
              </span>
            </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="antd-input h-9 sm:h-10 text-xs sm:text-sm px-3"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <select
                    name="gender"
                    className="antd-input h-9 sm:h-10 text-xs sm:text-sm px-2.5"
                  >
                ...
                <div className="space-y-1">
                  <label className="text-xs font-bold text-[var(--antd-text)] flex items-center gap-1">
                    <Calendar className="w-3 h-3 text-[var(--antd-primary)]" />{" "}
                    তারিখ *
                  </label>
                  <input
                    type="date"
              ...
              {/* Row 4: Time Slot Selection (Ant Design Radio Chips) */}
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  <label className="text-xs font-bold text-[var(--antd-text)] flex items-center gap-1">
                    <Clock className="w-3 h-3 text-[var(--antd-primary)]" />{" "}
                    পছন্দের সময় স্লট নির্বাচন করুন *
                  </label>
                  ...
                  {TIME_SLOTS.map((slot, idx) => {
                    ...
                    return (
                      <button
                        ...
                        className={`py-2 px-2.5 rounded-lg text-xs font-medium border text-left transition-all flex items-center justify-between ${
                          isSelected
                      ...
                      >
                        <span>{slot}</span>
                        {isSelected && (
                          <CheckCircle2 className="w-3.5 h-3.5 text-[var(--antd-primary)] shrink-0" />
                        )}
                      </button>
                    );
                  })}
              ...
              {/* Row 5: Dental Issues & Quick Complaint Chips */}
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-[var(--antd-text)]">
                  দাঁতের সমস্যা বা উপসর্গ (ঐচ্ছিক)
                </label>
                ...
                <div className="flex flex-wrap gap-1.5 pb-1">
                  {QUICK_COMPLAINTS.map((c, i) => (
                    <button
                      ...
                      className="text-[11px] px-2 py-0.5 rounded-md border border-[var(--antd-border-split)] bg-[var(--antd-bg-layout)]/80 text-[var(--antd-text-secondary)] hover:text-[var(--antd-primary)] hover:border-[var(--antd-primary)] transition-colors"
                    >
                      + {c}
                    </button>
                  ))}
                ...
                <textarea
                  ...
                  rows={2}
                  placeholder="আপনার কোনো নির্দিষ্ট উপসর্গ বা ব্যথা থাকলে এখানে সংক্ষেপে লিখুন..."
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full antd-btn antd-btn-primary h-11 font-bold text-xs sm:text-sm shadow-sm active:scale-[0.99] transition-all flex items-center justify-center gap-2"
                >
                  <Send className="w-4 h-4" />
                  <span>
                    {isSubmitting
                      ? "সিরিয়াল কনফার্ম করা হচ্ছে..."
                      : "সিরিয়াল কনফার্ম করুন ও ইনস্ট্যান্ট টোকেন নিন"}
                  </span>
                </button>
                <div className="flex items-center justify-center gap-3 pt-2 text-[11px] text-[var(--antd-text-tertiary)]">
                  <span className="flex items-center gap-1">
                    <ShieldCheck className="w-3 h-3 text-[var(--antd-success)]" />{" "}
                    কোনো আগাম ফি নেই
                  </span>
                  <span>•</span>
                  <span>ইনস্ট্যান্ট এসএমএস নোটিফিকেশন</span>
                </div>
              </div>
            </Form>
          </div>
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="bg-[var(--antd-bg-container)] border border-[var(--antd-border-split)] rounded-2xl p-4 sm:p-5 shadow-xs space-y-3.5">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-xl bg-[var(--antd-primary-bg)] border border-[var(--antd-primary-border)] flex items-center justify-center text-[var(--antd-primary)] font-bold text-sm">
                  ডা.
                </div>
                <div>
              ...
              <div className="pt-2 border-t border-[var(--antd-border-split)] space-y-2 text-xs text-[var(--antd-text-secondary)]">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>বিকাল ৫:০০ - রাত ৯:৩০ (শনি - বৃহঃ)</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[var(--antd-primary-bg)]/50 border border-[var(--antd-primary-border)] rounded-2xl p-4 sm:p-5 shadow-xs space-y-2.5">
              ...
              <p className="text-xs text-[var(--antd-text-secondary)] leading-relaxed">
                অনলাইনে সিরিয়াল নেওয়ার পর চেম্বারে দীর্ঘক্ষণ ভিড় করতে হয় না।
                সরাসরি লাইভ কিউ থেকে ট্র্যাক করে নিজের সময়ে চলে আসুন।
              </p>
              <Link
                href="/live-queue"
                className="inline-flex items-center gap-1 text-xs font-bold text-[var(--antd-primary)] hover:underline pt-1"
              >
                <span>আজকের রানিং সিরিয়াল দেখুন</span>
            ...
            <div className="bg-[var(--antd-bg-container)] border border-[var(--antd-border-split)] rounded-2xl p-4 sm:p-5 shadow-xs space-y-2.5 text-xs text-[var(--antd-text-secondary)]">
              ...
              <ul className="space-y-1.5 text-[11px]">
                <li className="flex items-center gap-1.5">
                  ...
                  <span>ইউরোপিয়ান ক্লাস-বি অটোকেভ স্টেরিলাইজেশন</span>
                </li>
                <li className="flex items-center gap-1.5">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[var(--antd-success)] shrink-0" />
                  <span>লোকাল পেইনলেস অ্যানাস্থেসিয়া ও আধুনিক টেকনোলজি</span>
                </li>
                <li className="flex items-center gap-1.5">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[var(--antd-success)] shrink-0" />
                  <span>ডিজিটাল প্রেসক্রিপশন ও ৬ মাসের অটো-ফলোআপ</span>
                </li>
              </ul>
            </div>
          </div>
